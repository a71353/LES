...
class TemaQ(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)
    tema = models.CharField(db_column='Tema', max_length=64, unique=True)
...
class Atividade(models.Model):
    ...
    roteiro = models.ForeignKey('roteiros.Roteiro', on_delete=models.SET_NULL, null=True, db_column='RoteiroID', blank=True)
...
class Sessao(models.Model):
    ...
    roteiroid = models.ForeignKey(Roteiro, models.CASCADE, db_column='RoteiroID', blank=True, null=True)
