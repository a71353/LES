...
urlpatterns = [
    ...
    path('mensagem1/<int:id>', views.mensagem1,name='mensagem1'),
    path('mensagem2/<int:id>', views.mensagem2,name='mensagem2'),
    path('mensagem3/<int:id>', views.mensagem3,name='mensagem3'),
    ...
    path('mensagem8/<int:id>', views.mensagem8,name='mensagem8'),
