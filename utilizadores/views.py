...
def mensagem1(request, id, *args, **kwargs):
    ...
    if id == 400 or id == 500:
        ...
        m = "Não existe questionário com perguntas e respostas para esse tema no ano selecionado"
        tipo = "error"
...
def mensagem3(request, id, *args, **kwargs):
    ...
    if id == 400 or id == 500:
        ...
        m = "Este tema está associado a Questionários"
        tipo = "error"
...
def mensagem6(request, id, *args, **kwargs):
    ...
    if id == 400 or id == 500:
        ...
        m = "Não existe dados para esse ano"
        tipo = "error"
...
@handle_db_errors
def mensagem7(request, id, *args, **kwargs):
    ''' Template de mensagens informativas/erro/sucesso '''
    ...
    if id == 400 or id == 500:
        ...
        m = "Este utilizador não está autorizado a fazer alterações nesse dia aberto"
        tipo = "error"
...
def mensagem(request, id, *args, **kwargs):
    ...
    if id == 400 or id == 500:
        ...
        m = "O questionario solicitado ja foi respondido pelo usuario"
        tipo = "error"
    elif id == 1001:
        m = "O questionario solicitado não pode ser Validado"
        tipo = "error"
    elif id == 1002:
        m = "O questionario solicitado não pode ser Rejeitado"
        tipo = "error"
    elif id == 1003:
        m = "O questionario solicitado não pode ser Publicado"
        tipo = "erro"
    elif id == 1007:
        m = "Não é possível Editar as respostas do questionario solicitado"
        tipo = "error"
    elif id == 1008:
        m = "NAO TEM QUESTIONARIOS PRA RESPONDER"
        tipo = "error"
    
    
    
    elif id == 1014:
        m = "Nao esta autenticado"
        tipo = "error"
    elif id == 1015:
        m = "Nao existe dia aberto para o ano atual"
        tipo = "error"
    elif id == 2000:
        m = "TESTE"
        tipo = "error"
    elif id == 2001:
        m = "O questionario foi respondido com sucesso!"
        tipo = "success"
    elif id == 3000:
    ...
    #Questionarios
        ...
        m = "O questionario solicitado não existe"
        tipo = "error"
    elif id == 7002:
        m = "O Utilizador não possui permissoões para validar um questionario"
        tipo = "error"
    elif id == 7003:
        m = "O questionario solicitado não pode ser Validado"
        tipo = "error"
    elif id == 7004:
        m = "O Utilizador não possui permissoões para rejeitar um questionario"
        tipo = "error"
    elif id == 7005:
        m = "O questionario solicitado não pode ser Rejeitado"
        tipo = "error"
        ...
        m = "O Questionário não pode ser publicado pois o período de publicação ja passou"
        tipo = "error"
    elif id == 7009:
        m = "O utilizador não possui permissões para despublicar um questionario"
        tipo = "error"
    elif id == 7010:
        m = "O questionario não pode ser despublicado"
        tipo = "error"
    elif id == 7011:
        m = "O utilizador não possui permissões para arquivar um questionario"
        tipo = "error"
    elif id == 7012:
        m = "O questionario solicitado não pode ser Arquivado"
        tipo = "error"
    elif id == 7013:
        m = "O utilizador não possui permissões para desarquivar um questionario"
        tipo = "error"
    elif id == 7014:
        m = "O questionario solicitado não pode ser Desarquivado"
        tipo = "error"
    elif id == 7015:
        m = "O Utilizador não possui permissões para exportar(draft) um questionario"
        tipo = "error"
    elif id == 7016:
        m = "O Utilizador não possui permissões para exportar um questionario"
        tipo = "error"
    #questionariosPublicados
    elif id == 8000:
        m = "Somente Participantes podem responder ao Questionario"
        tipo = "info"
    elif id == 8001:
        m = "O questionario foi respondido com sucesso!"
        tipo = "success"
    elif id == 8002:
        m = "Não existem nenhum Diaaberto para o ano atual!"
        tipo = "error"
    elif id == 8003:
    ...
    #Relatórios#######################################
        ...
        m = "Não existem almoços para o Dia Aberto do ano fornecido."
        tipo = "error"
    elif id == 8007:
        m = "O Utilizador não possui permissões para exportar um relatório em pdf"
        tipo = "error"
    elif id == 8008:
        m = "Não existem InscricoesPrato para o ano selecionado"
        tipo = "error"
    elif id == 8009:
        m = "Dia não especificado"
        tipo = "error"
    elif id == 8010:
        m = "O Utilizador não possui permissões para exportar um relatório em csv"
        tipo = "error"
    #Estatisticas##############################
    elif id == 9000:
        m = "O Utilizador não possui permissões para visualizar as Estatisticas de almocos"
        tipo = "error"
    elif id == 9001:
